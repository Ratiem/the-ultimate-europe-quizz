...
let questions = [
    ...
    {
      question:
        "Amsterdam, The Netherlands is the largest container port in Europe?",
      answer1: "True",
      answer2: "False",
      correct: "False",
    },
    ...
    {
      question:
        "If you are flying to Charles de Gaulle, you are flying to Rome, Italy?",
      answer1: "True",
      answer2: "False",
      correct: "False",
    },
  ...
  function rules() {
    introArea.innerHTML = `<h3>Rules</h3>
      <ol id="rules">
  ...
  function displayQuestion() {
    questionTitle.innerText = `Question ${questionCounter + 1} of ${
      questions.length
    }`;
    console.log("Processing question number " + questionCounter);
    questionElement.innerText = questions[questionCounter].question;
    answerOne.innerText = questions[questionCounter].answer1;
    answerTwo.innerText = questions[questionCounter].answer2;
  }
